<header>
  ...
  <navbar>
    ...
    <nav id="Article"><a href="<?php echo e(url('/category/all-artcle')); ?>">Article</a></nav>
    <nav id="search"><a href="<?php echo e(url('/search')); ?>">Search</a></nav>
    <nav id="legal"><a href="<?php echo e(url('/legal')); ?>">Legal</a></nav>
    <nav id="aboutme"><a href="<?php echo e(url('/aboout-us')); ?>">About me</a></nav>
  </navbar>
</header>
<?php /**PATH /var/www/html/php/L4T10/CapstoneProjectI/resources/views/layouts/webpage/header.blade.php ENDPATH**/ ?>